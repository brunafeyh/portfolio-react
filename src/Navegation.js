    ...
    <nav id="navigation">
      <div className="wrapper">
        ...
        <ul>
            ...
            <li>
              <a id="projectsNav" class="close" href="#projects">Portifólio</a>
            </li>
            <li>
            ...
            <li>
              <a id="contactNav" class="close" href="#contact">Contato</a>
            </li>
          </ul>
          ...
          <ul class="social-links">
            <li>
              <a
                href="https://www.instagram.com/brunadasilvafeyh/"
                title="Instagram"
                target="_blank"
                ><svg
                  width="24"
            ...
            <li>
              <a
                href="https://github.com/brunafeyh"
                title="Github"
                target="_blank"
                ><svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/brunadasilvafeyh/"
                title="LinkedIn"
                target="_blank"
                ><svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <a
                href="https://twitter.com/brufeyh"
                title="Twitter"
                target="_blank"
                ><svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <button
          ...
          className={`open-menu ${isMenuOpen ? 'open' : ''}`}
          onClick={toggleMenu}
        >
          {/* ... ícone do botão de abertura do menu ... */}
        </button>

        <button
          aria-expanded={isMenuOpen ? 'true' : 'false'}
          aria-label={isMenuOpen ? 'Fechar menu' : 'Abrir menu'}
          className={`close-menu ${isMenuOpen ? 'close' : ''}`}
          onClick={toggleMenu}
        >
          {/* ... ícone do botão de fechamento do menu ... */}
        </button>
      </div>
    </nav>
  );
